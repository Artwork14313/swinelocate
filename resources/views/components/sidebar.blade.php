...
>
    ...
    <div class="fixed top-0 left-0 right-0 z-30 h-16 bg-white border-b border-gray-200 flex items-center justify-between px-4">
    ...
    <aside
        ...
        class="fixed inset-y-0 left-0 z-50 flex w-72 flex-col
               border-r border-gray-200 bg-[#F2F2ED] shadow-xl"
        style="display: none;"
    >
        ...
        <div class="flex-1 overflow-y-auto px-4 py-5">
            ...
            <div class="mb-6">
                ...
                <div class="space-y-1">
                    ...
                    <a
                        href="{{ route('health-records.history.index') }}"
                        @click="sidebarOpen = false"
                        class="flex items-center gap-3 rounded-lg px-3 py-2
                               text-sm font-medium
                               {{
            ...
            <div class="mb-6">
                ...
                <div class="space-y-1">
                    ...
                    <a
                        href="{{ route('growth-monitoring.index') }}"
                        @click="sidebarOpen = false"
                        class="flex items-center gap-3 rounded-lg px-3 py-2
                               text-sm font-medium
                               {{
